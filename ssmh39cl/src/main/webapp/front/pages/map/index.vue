<template>
	<view class="content">
		...
		<map v-show="!IsOption" id="map" style="width: 100%; height: 480px;z-index: -1;" :latitude="latitude" :longitude="longitude" :markers="markers"
			 show-location></map>
	...
	export default {
		...
		methods: {
			search() {
				...
				self.mapSearch(self.key, location).then(res => {
					// console.log(111, res)
					self.data = res.data
